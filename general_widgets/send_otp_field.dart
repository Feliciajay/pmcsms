...
class SendOtpField extends StatefulWidget {
  const SendOtpField({
    super.key,
    this.label,
    this.onChanged,
  ...
  @override
  State<SendOtpField> createState() => _SendOtpFieldState();
}

class _SendOtpFieldState extends State<SendOtpField> {
            ...
            validator: widget.validator ??
                (text) {
                  if (text == null ||
                    ...
                    return widget.errorMessage ?? 'Invalid Pin';
                  }
                  return null;
                },
          ),
...
class DSPinTheme extends PinTheme {
  DSPinTheme({
    ...
    double width = 48,
    double height = 50,
    Color color = AppColors.primaryCBD5E1,
  }) : super(
          width: width,
          height: height,
