class VerifySignupEmailOtpReponse {
  ...
  VerifySignupEmailOtpReponse copyWith({
  ...
  factory VerifySignupEmailOtpReponse.fromJson(Map<String, dynamic> json) =>
      VerifySignupEmailOtpReponse(
